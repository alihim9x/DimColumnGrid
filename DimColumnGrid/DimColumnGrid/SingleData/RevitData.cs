...
namespace SingleData
{
    public class RevitData
    {
        ...
        private IEnumerable<FamilyInstance> familyinstancesinplanview;
        public virtual IEnumerable<FamilyInstance> FamilyInstancesInPlanView
        {
            get
            {
                if(familyinstancesinplanview == null)
                {
                    familyinstancesinplanview = instanceElementsInPlanViewRvL.Where(x => x is FamilyInstance).Cast<FamilyInstance>();
                }
                return familyinstancesinplanview;
            }
        }
        ...
        private IEnumerable<Element> instanceElementsInPlanViewRvL;
        public virtual IEnumerable<Element> InstanceElementsInPlanViewRvL
        {
            get
            {
                if(RevitLinkDocument != null && instanceElementsInPlanViewRvL == null)
                {
                    var solidActivew = ActiveView.CreateCutPlaneSolid();
                    var solidIntersecFil = new Autodesk.Revit.DB.ElementIntersectsSolidFilter(solidActivew);
                    instanceElementsInViewRvL = new FilteredElementCollector(RevitLinkDocument)?.WhereElementIsNotElementType()
                        .WherePasses(solidIntersecFil);

                }
                return instanceElementsInPlanViewRvL;
            }
        }
        
        private IEnumerable<FamilyInstance> columninstancesinviewrvL;
        public virtual IEnumerable<FamilyInstance> ColumnInstancesInViewRvL
        {
            get
            {
                if(columninstancesinviewrvL == null)
                {
                    columninstancesinviewrvL = InstanceElementsInViewRvL.Where(x => x.Category.Id.IntegerValue == (int)BuiltInCategory.OST_StructuralColumns).Cast<FamilyInstance>();
                }
                return columninstancesinviewrvL;
            }
        }
        private IEnumerable<Wall> wallinstancesinviewrvL;
        public virtual IEnumerable<Wall> WallInstancesInViewRvL
        {
            get
            {
                if(wallinstancesinviewrvL == null)
                {
                    wallinstancesinviewrvL = InstanceElementsInViewRvL.Where(x => x is Wall).Cast<Wall>();
                }
                return wallinstancesinviewrvL;
        ...
        private IEnumerable<Grid> gridsinview;
        public virtual IEnumerable<Grid> GridsInView
        {
            get
            {
                if(gridsinview == null)
                {
                    gridsinview = InstanceElementsInView.Where(x => x is Grid).Cast<Grid>();
                }
                return gridsinview;
            }
        }
